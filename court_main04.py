...
class HighCourt:
    ...
    def detect_faces(self):
        ...
        cooldown_period = 15  # Increase cooldown period to reduce frequency of detections
        min_face_size = (160, 160) 
        max_face_size = (240, 240)
        frame_counter = 0  # Counter to control GUI update frequency
        ...
        while self.is_running:
            ...
            # Check if we should trigger case number prompt
            ...
            # Update the GUI every 5 frames to reduce CPU usage
            ...
            frame_counter += 1
            time.sleep(0.3)  # Reduce frame rate to ~10 FPS
