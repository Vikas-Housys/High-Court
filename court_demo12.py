...
class HighCourt:
    def __init__(self, root):
        ...
        self.search_label.pack(side="left", padx=10, pady=5)  # Now it can be packed
        ...
        # Add Numeric Key board.
        # Task: add 0 to 9 buttons in 2 rows, to enter the case number in text_input.
    ...
    def create_case_table(self):
        ...
        # Style the table using ttk.Style
        style = ttk.Style()

        # Configure heading style with blue font color
        style.configure("Treeview.Heading", 
                        font=('Helvetica', 16, 'bold'), 
                        foreground="black")  # Blue font color for headings

        # Configure row style with blue font color
        style.configure("Treeview", 
                        font=('Helvetica', 14, "bold"), 
                        foreground="blue",  # Blue font color for rows
                        rowheight=25)
