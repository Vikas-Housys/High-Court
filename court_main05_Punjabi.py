...
class HighCourt:
    ...
    def detect_faces(self):
        ...
        while self.is_running:
            ...
            cv2.putText(frame_rgb, "ਖੋਜ ਰੇਂਜ", (10, 30), 
            ...
            for (x, y, w, h) in faces:
                ...
                if (x_start < face_center_x < x_end and 
                    ...
                    cv2.putText(frame_rgb, "ਖੋਜਿਆ ਗਿਆ", (x, y-10), 
                    ...
                    if face_size < min_face_size[0]:
                        range_text = "ਬਹੁਤ ਦੂਰ"  # Too Far
                    elif face_size > max_face_size[0]:
                        range_text = "ਬਹੁਤ ਨੇੜੇ"
                    ...
                    cv2.putText(frame_rgb, "ਜ਼ੋਨ ਤੋਂ ਬਾਹਰ", (x, y-10), 
