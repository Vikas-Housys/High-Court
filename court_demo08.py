...
class HighCourt:
    def __init__(self, root):
        ...
        self.header_image = self.load_image("images/court02.jpg", (840, 320))
        ...
        self.text_input_label.pack(padx=(5, 5))

        # Create a frame to hold the text input and mic button
        self.input_frame = ctk.CTkFrame(self.main_frame)
        self.input_frame.pack(padx=10, pady=10)

        # Text input box
        self.text_input = ctk.CTkEntry(self.input_frame, font=ctk.CTkFont(size=24, weight="bold"), width=640, height=60)
        self.text_input.pack(side="left", padx=(10, 10))
    ...
    def speak_text(self, text, lang="en"):
        try:
            ...
            # Unload the music file to release it
            pygame.mixer.music.unload()

            # Delete the speech file after playback
