...
class Conversation:
    ...
    def speak_text(self, text, lang="en"):
        try:
            ...
            time.sleep(self.get_audio_length())
...
class CourtApplication:
    ...
    def create_gui(self):
        ...
        mic_button = tk.Button(
            ...
            relief="raised",
            bd=4, 
            command=self.manual_voice_input  # Use the normal function 
        )
        mic_button.pack()
        ...
        for text, lang in languages:
            btn = tk.Button(
                ...
                relief="raised",
                bd=4,
                command=lambda lang=lang: self.on_button_click(lang)  # Use lambda to pass argument
            )
