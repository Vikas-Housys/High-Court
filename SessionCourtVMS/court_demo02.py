...
class HighCourt:
    def __init__(self, root):
        ...
        self.close_button = ctk.CTkButton(
            ...
            font=ctk.CTkFont(size=24, weight="bold"),
            fg_color="#FF0000",  # Red color for close button
            text_color="white",
            height=60,
            width=180,
            border_width=2,
        ...
        self.reset_button = ctk.CTkButton(
            ...
            font=ctk.CTkFont(size=24, weight="bold"),
            fg_color="#FF5733",  # Red color for reset button
            text_color="white",
            height=60,
            width=180,
            border_width=2,
    ...
    def close_application(self):
        """Close the application after verifying the password."""
        password = ctk.CTkInputDialog(text="Enter password to close:", title="Password Verification").get_input()
        if password:
    ...
    def create_case_table(self):
        ...
        self.table_frame = ctk.CTkFrame(self.main_frame, width=940, height=100,
                                        border_width=2,
                                        border_color="black",
