...
class HighCourt:
    ...
    def create_numeric_keypad(self):
        ...
        # Add a backspace button in the next row
        ...
        backspace_button.grid(row=len(buttons), column=1, padx=5, pady=5)  # Place in the center of the next row
    ...
    def create_case_table(self):
        ...
        self.table_frame = ctk.CTkFrame(self.main_frame, width=940, height=200,
                                        border_width=2,
                                        border_color="blue",
